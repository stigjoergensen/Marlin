...
//#define CUSTOM_MACHINE_NAME "Clearsky"
...
#define HOTEND_OFFSET_X {0.0, 0.0} // (in mm) for each extruder, offset of the hotend on the X axis  // 64.5 mm to 2nd extruder
...
#define HEATER_1_MAXTEMP 299
#define HEATER_2_MAXTEMP 299
#define HEATER_3_MAXTEMP 299
